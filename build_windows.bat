...
python -m PyInstaller --name "interiorcad FolderCheck" --onefile --windowed --icon icon.ico --add-data "icon.png;." --add-data "icon_tray_Template.png;." --add-data "icon_tray_Template.png;." --collect-all tkinter --collect-all pystray --collect-all plyer --hidden-import tkinter --hidden-import tkinter.ttk --hidden-import tkinter.filedialog --hidden-import tkinter.messagebox --hidden-import pystray --hidden-import PIL --hidden-import plyer.platforms.win.notification --clean --noconfirm main.py
